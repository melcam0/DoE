                      ...
                      tabsetPanel(type = "tabs",
                                  tabPanel("Disegno",
                                         ...
                                         #         uiOutput('pp_selinteraz')),
                                           ...
                                           column(6,
                                                  br(),
                                                  checkboxInput("pp_vincoli", label = "Vincoli", value = FALSE),
                                  ...
                                  tabPanel("Modello",
                                          ...
                                          #        uiOutput('pp_mod_selinteraz')),
                                           ...
                                           column(6,
                                                 ...
                                                 # br(),
                                                  checkboxInput("pp_vincolirisp", label = "Vincoli", value = FALSE),
                                          ...
                                          column(12,br(),
                                                 h3('Grafico semi-ampiezza intervallo confidenza previsione')),
                                          column(3,
                                          ...
                                          column(6,
                                                 br(),
                                                 checkboxInput("pp_vincoli_icp", label = "Vincoli", value = FALSE),
                      ...
                      tabsetPanel(type = "tabs",
                                  ...
                                  tabPanel("Modello",
                                           ...
                                           column(2,
                                                  ...
                                                  br(),
                                                  br(),
                                                  radioButtons("m_simplex_resind", label = h3("Stima della varianza da:"),
                                                               choices = list("Residui" = 1, "Misure indipendenti" = 2), 
                                                               selected = 1)),
                                           column(12,
                                                  hr(),
                                           ...
                                           column(4,
                                                  ...
                                                  checkboxInput("m_simplex_livellorisp_perc", label = "percentuali", value = FALSE),
                                                  checkboxInput("m_simplex_livellorisp_reg", label = "regioni", value = TRUE)),
                                           column(8,
                                                  hr(),
                                                  h3("Grafico superficie risposta"),
                                                  br(),
                      ...
                      tabsetPanel(type = "tabs",
                                  ...
                                  tabPanel('D-ottimale',
                                           ...
                                           column(6,
                                                  ...
                                                  actionButton('m_d_opt_calc','Calcola'),
                                                  hr()),
                                           column(6,
                                  ...
                                  tabPanel('D-ottimale per aggiunta',
                                           column(12,
                                                  br()),
                                           column(4,
                                                  radioButtons("m_d_opt_ag_importa", label = "Importa disegno:",
                                                               choices = list("Incolla" = 1, "Excel" = 2), 
                                                               selected = 1,inline = TRUE)),
                                           column(4,
                                           ...
                                           column(6,
                                                  ...
                                                  actionButton('m_d_opt_ag_calc','Calcola'),
                                                  hr()),
                                           column(6,
                      ...
                      tabsetPanel(type = "tabs",
                                  tabPanel("Disegno",
                                           column(12,
                                                  br()),
                                           column(4,
                                                  radioButtons("m_pp_importa", label = "Importa disegno:",
                                                               choices = list("Incolla" = 1, "Excel" = 2), 
                                                               selected = 1,inline = TRUE)),
                                           column(4,
                                           ...
                                           column(6,
                                                  br(),
                                                  checkboxInput("m_pp_vincoli", label = "Vincoli", value = FALSE)),
                                           column(12),
                                           column(6,
