  ...
  # hr(color="#CBA727"),
    sidebarMenu(
                ...
                menuItem(text = "File",icon = icon("briefcase", lib = "font-awesome"),
                         ...
                         HTML('<p><center><font color="cyan"><br> Version 6.11 </font></center>'))
                               ...
                               tabsetPanel(type = "tabs",
                                           tabPanel("Design",
                                                    column(12,
                                                           br()),
                                                    column(4,
                                                           numericInput("fatt_compl_k",label="n° factors",width = "25%",value = 2,min = 1),
                                                           h4('Design'),
                               ...
                               tabsetPanel(type = "tabs",
                                           tabPanel("Design",
                                                    column(12,
                                                           ...
                                                           br()),
                                                    column(4,
                                                           numericInput("frazion_k",label="n° factors",width = "25%",value = 3,min = 3),
                                                           numericInput("frazion_p",label="n° generators",width = "25%",value = 1)),
                               ...
                               tabsetPanel(type = "tabs",
                                           tabPanel("Design",
                                                    column(12,
                                                           ...
                                                           br()),
                                                    column(4,
                                                           numericInput("pb_k",label="n° factors",width = "25%",value = 5,min = 5),
                                                           uiOutput("pb_n")),
                                                    column(8,
                                                           uiOutput("dis16"),
                               ...
                               tabsetPanel(type = "tabs",
                                           tabPanel("Design",
                                                    column(12,
                                                           br()),
                                                    column(4,
                                                           numericInput("ccd_k",label="n° factors",width = "25%",value = 2,min = 2),
                                                           numericInput("ccd_n",label="n° center points",width = "25%",value = 1),
